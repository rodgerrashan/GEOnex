    ...
    <div>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <select
          ...
          className="text-blue-600 cursor-pointer outline-none px-2 py-1 dark:text-indigo-400 dark:bg-gray-800"
        >
          <option>CM</option>
          <option>FEET</option>
        </select>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <select
          className="text-gray-800 cursor-pointer outline-none px-2 py-1 dark:text-indigo-400 dark:bg-gray-800"
          disabled
      ...
      <div className="flex flex-col md:flex-row gap-2 mt-6 mx-4">
        <input
          ...
          disabled
          className="flex-1 min-w-0 bg-gray-200 rounded-full py-1 px-2 text-center text-gray-800 dark:bg-gray-700 dark:text-gray-400 cursor-not-allowed"
        />
        <input
          value={data.latitude}
          type="text"
